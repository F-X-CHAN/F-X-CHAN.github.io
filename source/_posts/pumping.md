...
<figure>
<img src="./img/pumping/2026-06-16-14-41-38-image.png" title="" alt="" width="317">
</figure>

在晶格体系中，也有类似 pumping；

<figure>
<img src="./img/pumping/2026-06-18-12-12-50-image.png" title="" alt="" width="317">
...
$$
\mathcal{A}_{\mu} = i \lang \Phi | \partial_{\mu} \Phi \rang
$$

也就是需要计算不同磁通下的 $|\Phi\rang$。计算中会计算 twisted boundary condition 下的基态波函数 $\psi_\theta$，满足
...
$$
\frac{\text{d}}{\text{d}t} \ln \lang Z \rang = J
$$
...
<img src="file:///C:/Users/F_X/AppData/Roaming/marktext/images/2026-06-18-14-32-50-image.png" title="" alt="" width="525">
...
<figure>
    <img title="" src="./img/pumping/2026-06-15-15-14-27-image.png" alt="" width="306">
...
对于没有简并的情形，polarization  $\propto \ln{\lang \psi | \hat{Z} | \psi \rang}$；
对于简并基态的空间，polarization 应当对于子空间中的旋转不变，因此需要是  $\propto \ln \det{\lang \psi_i | \hat{Z} | \psi_j\rang}$. 
